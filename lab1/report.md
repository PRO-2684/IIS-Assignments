...
- 我们选择了第一篇论文《New Directions in Cryptography》，作者在他们的论文中开创了公钥密码学（非对称密码学）的概念，这是密码学历史上的一次革命。他们提出了一种机制，其中加密和解密使用两个不同的密钥，这与之前的对称加密系统形成了鲜明对比，在对称加密系统中，加密和解密使用相同的密钥。在非对称加密系统中，有一个公开的密钥用于加密，而另一个私有的密钥用于解密。这样，即使在不安全的通信渠道上，两个没有事先共享密钥的个体也能安全地进行通信。论文的主要内容总结如下：
